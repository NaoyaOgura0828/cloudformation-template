...
# main 変更対象リソース
#####################################
# exec_change_set ${SYSTEM_NAME_TEMPLATE} ${ENV_TYPE_MAIN} ${REGION_NAME_VIRGINIA} iam-flowlog
# exec_change_set ${SYSTEM_NAME_TEMPLATE} ${ENV_TYPE_MAIN} ${REGION_NAME_TOKYO} network
# exec_change_set ${SYSTEM_NAME_TEMPLATE} ${ENV_TYPE_MAIN} ${REGION_NAME_TOKYO} network-flowlog
# exec_change_set ${SYSTEM_NAME_TEMPLATE} ${ENV_TYPE_MAIN} ${REGION_NAME_TOKYO} transitgateway
# exec_change_set ${SYSTEM_NAME_TEMPLATE} ${ENV_TYPE_MAIN} ${REGION_NAME_TOKYO} resourceaccessmanager
# exec_change_set ${SYSTEM_NAME_TEMPLATE} ${ENV_TYPE_MAIN} ${REGION_NAME_TOKYO} transitgateway-attachment
# exec_change_set ${SYSTEM_NAME_TEMPLATE} ${ENV_TYPE_MAIN} ${REGION_NAME_TOKYO} transitgateway-routetable

#####################################
# sub 変更対象リソース
#####################################
# exec_change_set ${SYSTEM_NAME_TEMPLATE} ${ENV_TYPE_SUB} ${REGION_NAME_VIRGINIA} iam-flowlog
# exec_change_set ${SYSTEM_NAME_TEMPLATE} ${ENV_TYPE_SUB} ${REGION_NAME_TOKYO} network
# exec_change_set ${SYSTEM_NAME_TEMPLATE} ${ENV_TYPE_SUB} ${REGION_NAME_TOKYO} network-flowlog
# accept_resource_share_invitation ${SYSTEM_NAME_TEMPLATE} ${ENV_TYPE_SUB} ${REGION_NAME_TOKYO}
# exec_change_set ${SYSTEM_NAME_TEMPLATE} ${ENV_TYPE_SUB} ${REGION_NAME_TOKYO} transitgateway-attachment
